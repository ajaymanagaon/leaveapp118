...
//                console.log($( this ).css( "background-color" ))
                if($( this ).css( "background-color" ) == "rgb(255, 0, 0)" || $( this ).css( "background-color" ) == "rgb(0, 0, 255)" || $(this).hasClass("bg-primary") || $(this).hasClass("bg-danger")  || $( this ).css( "background-color" ) == "rgb(220, 53, 69)" || $( this ).css( "background-color" ) == "rgb(0, 123, 255)" || $( this ).css( "background-color" ) == "rgb(128, 128, 128)")
                    {
...
//                                    })
    ...
    $("#dailyReportButton").on("click",function(){
        $.ajax({
            data:1,
            type:"GET",
            url:"/dailyReportButton",
            success: function (data)
              {
              console.log("Inside DailyReport");
              },
            error: function (error)
              {
